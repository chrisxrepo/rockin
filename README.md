...
yum install -y devtoolset-8-gcc devtoolset-8-gcc-c++ && scl enable devtoolset-8 bash
yum install -y gflags-devel glog-devel jemalloc-devel libuv-devel zlib-devel bzip2-devel snappy-devel
```
##### Ubuntu18.10
```
apt-get install -y gcc gcc-g++
...
cd rocksdb && git checkout v5.18.3  \ 
    && git cherry-pick 8a1ecd1982341cfe073924d36717e11446cbe492 \
    && DEBUG_LEVEL=0 make shared_lib && make install-shared 
